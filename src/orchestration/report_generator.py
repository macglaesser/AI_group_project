...
with open(f'reports/{student_id}/recommendations.json', 'r', encoding='utf-8') as f:
...
output_filename = f"reports/{student_id}/recommendation_report_{profile_data['student_id']}_{timestamp}.html"
